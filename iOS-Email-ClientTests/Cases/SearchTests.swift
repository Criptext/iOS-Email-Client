...
class SearchTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let email1 = DBFactory.createAndStoreEmail(key: 1, preview: "Test Email 1", subject: "Test Email 1", fromAddress: "test1 <test1@criptext.com>")
        let email2 = DBFactory.createAndStoreEmail(key: 2, preview: "Test Email 2", subject: "Test Email 2", fromAddress: "test2 <test2@criptext.com>")
        let email3 = DBFactory.createAndStoreEmail(key: 3, preview: "Test Email 3", subject: "Test Email 3", fromAddress: "test A <test3@criptext.com>")
        let email4 = DBFactory.createAndStoreEmail(key: 4, preview: "Test Email 4", subject: "Test Email 4", fromAddress: "test A <test4@criptext.com>")
        let email5 = DBFactory.createAndStoreEmail(key: 5, preview: "Test Email 5", subject: "Test Email 5", fromAddress: "test3 <test3@criptext.com>")
        
        let contact1 = DBFactory.createAndStoreContact(email: "test1@criptext.com", name: "Test1")
        let contact2 = DBFactory.createAndStoreContact(email: "test2@criptext.com", name: "Test2")
        let contact3 = DBFactory.createAndStoreContact(email: "test3@criptext.com", name: "Test3")
        let contact4 = DBFactory.createAndStoreContact(email: "test4@criptext.com", name: "Test4")
