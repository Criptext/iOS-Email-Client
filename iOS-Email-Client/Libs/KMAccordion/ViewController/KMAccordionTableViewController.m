...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)sectionIndex
{
    ...
    sectionHeaderView.labelName.text = currentSection.title;
    sectionHeaderView.labelWeight.text = currentSection.filesize;
    sectionHeaderView.labelTotalOpens.text = [NSString stringWithFormat:@"%ld Opens",(long)currentSection.totalOpens];
    sectionHeaderView.labelTotalDownloads.text = [NSString stringWithFormat:@"%ld Downloads",(long)currentSection.totalDownloads];
    [sectionHeaderView.imageViewFile setImage:currentSection.imageFile];
    ...
    if(self.sections.count == 1 || currentSection.totalOpens + currentSection.totalDownloads == 0){
        [sectionHeaderView disableButton];
    }
